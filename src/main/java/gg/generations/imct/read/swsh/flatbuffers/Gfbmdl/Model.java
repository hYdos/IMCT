...
public final class Model extends Table {
  ...
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.BoundingBox bounding(gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.BoundingBox obj) { int o = __offset(6); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  ...
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.UnknownEmpty unknown(int j) { return unknown(new gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.UnknownEmpty(), j); }
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.UnknownEmpty unknown(gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.UnknownEmpty obj, int j) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int unknownLength() { int o = __offset(12); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.UnknownEmpty.Vector unknownVector() { return unknownVector(new gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.UnknownEmpty.Vector()); }
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.UnknownEmpty.Vector unknownVector(gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.UnknownEmpty.Vector obj) { int o = __offset(12); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Material materials(int j) { return materials(new gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Material(), j); }
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Material materials(gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Material obj, int j) { int o = __offset(16); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int materialsLength() { int o = __offset(16); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Material.Vector materialsVector() { return materialsVector(new gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Material.Vector()); }
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Material.Vector materialsVector(gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Material.Vector obj) { int o = __offset(16); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Group groups(int j) { return groups(new gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Group(), j); }
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Group groups(gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Group obj, int j) { int o = __offset(18); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int groupsLength() { int o = __offset(18); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Group.Vector groupsVector() { return groupsVector(new gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Group.Vector()); }
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Group.Vector groupsVector(gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Group.Vector obj) { int o = __offset(18); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Mesh meshes(int j) { return meshes(new gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Mesh(), j); }
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Mesh meshes(gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Mesh obj, int j) { int o = __offset(20); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int meshesLength() { int o = __offset(20); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Mesh.Vector meshesVector() { return meshesVector(new gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Mesh.Vector()); }
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Mesh.Vector meshesVector(gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Mesh.Vector obj) { int o = __offset(20); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Bone bones(int j) { return bones(new gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Bone(), j); }
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Bone bones(gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Bone obj, int j) { int o = __offset(22); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int bonesLength() { int o = __offset(22); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Bone.Vector bonesVector() { return bonesVector(new gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Bone.Vector()); }
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Bone.Vector bonesVector(gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.Bone.Vector obj) { int o = __offset(22); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.CollisionGroup collisionGroups(int j) { return collisionGroups(new gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.CollisionGroup(), j); }
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.CollisionGroup collisionGroups(gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.CollisionGroup obj, int j) { int o = __offset(24); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int collisionGroupsLength() { int o = __offset(24); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.CollisionGroup.Vector collisionGroupsVector() { return collisionGroupsVector(new gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.CollisionGroup.Vector()); }
  public gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.CollisionGroup.Vector collisionGroupsVector(gg.generations.imct.read.swsh.flatbuffers.Gfbmdl.CollisionGroup.Vector obj) { int o = __offset(24); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
