...
public final class Bone extends Table {
  ...
  public boolean lockTranslation() { int o = __offset(4); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  public int unkBool2() { int o = __offset(6); return o != 0 ? bb.get(o + bb_pos) & 0xFF : 0; }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.BoneMatrix matrix() { return matrix(new gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.BoneMatrix()); }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.BoneMatrix matrix(gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.BoneMatrix obj) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  ...
  public static int createBone(FlatBufferBuilder builder,
    ...
    Bone.addLockTranslation(builder, lockTranslation);
    return Bone.endBone(builder);
  }

  public static void startBone(FlatBufferBuilder builder) { builder.startTable(3); }
  public static void addLockTranslation(FlatBufferBuilder builder, boolean lockTranslation) { builder.addBoolean(0, lockTranslation, false); }
