...
public final class MaterialPass extends Table {
  ...
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Shader shaders(int j) { return shaders(new gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Shader(), j); }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Shader shaders(gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Shader obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int shadersLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Shader.Vector shadersVector() { return shadersVector(new gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Shader.Vector()); }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Shader.Vector shadersVector(gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Shader.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.TextureParameter textureParameters(int j) { return textureParameters(new gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.TextureParameter(), j); }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.TextureParameter textureParameters(gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.TextureParameter obj, int j) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int textureParametersLength() { int o = __offset(8); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.TextureParameter.Vector textureParametersVector() { return textureParametersVector(new gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.TextureParameter.Vector()); }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.TextureParameter.Vector textureParametersVector(gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.TextureParameter.Vector obj) { int o = __offset(8); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.SamplerState samplers(int j) { return samplers(new gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.SamplerState(), j); }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.SamplerState samplers(gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.SamplerState obj, int j) { int o = __offset(10); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int samplersLength() { int o = __offset(10); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.SamplerState.Vector samplersVector() { return samplersVector(new gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.SamplerState.Vector()); }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.SamplerState.Vector samplersVector(gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.SamplerState.Vector obj) { int o = __offset(10); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.FloatParameter floatParameters(int j) { return floatParameters(new gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.FloatParameter(), j); }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.FloatParameter floatParameters(gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.FloatParameter obj, int j) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int floatParametersLength() { int o = __offset(12); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.FloatParameter.Vector floatParametersVector() { return floatParametersVector(new gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.FloatParameter.Vector()); }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.FloatParameter.Vector floatParametersVector(gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.FloatParameter.Vector obj) { int o = __offset(12); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Float4Parameter float4LightParameters(int j) { return float4LightParameters(new gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Float4Parameter(), j); }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Float4Parameter float4LightParameters(gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Float4Parameter obj, int j) { int o = __offset(16); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int float4LightParametersLength() { int o = __offset(16); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Float4Parameter.Vector float4LightParametersVector() { return float4LightParametersVector(new gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Float4Parameter.Vector()); }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Float4Parameter.Vector float4LightParametersVector(gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Float4Parameter.Vector obj) { int o = __offset(16); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Float4Parameter float4Parameters(int j) { return float4Parameters(new gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Float4Parameter(), j); }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Float4Parameter float4Parameters(gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Float4Parameter obj, int j) { int o = __offset(18); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int float4ParametersLength() { int o = __offset(18); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Float4Parameter.Vector float4ParametersVector() { return float4ParametersVector(new gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Float4Parameter.Vector()); }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Float4Parameter.Vector float4ParametersVector(gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Float4Parameter.Vector obj) { int o = __offset(18); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.IntParameter intParameters(int j) { return intParameters(new gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.IntParameter(), j); }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.IntParameter intParameters(gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.IntParameter obj, int j) { int o = __offset(22); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int intParametersLength() { int o = __offset(22); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.IntParameter.Vector intParametersVector() { return intParametersVector(new gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.IntParameter.Vector()); }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.IntParameter.Vector intParametersVector(gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.IntParameter.Vector obj) { int o = __offset(22); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.WriteMask writeMask() { return writeMask(new gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.WriteMask()); }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.WriteMask writeMask(gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.WriteMask obj) { int o = __offset(30); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Int_Extra intExtra() { return intExtra(new gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Int_Extra()); }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Int_Extra intExtra(gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.Int_Extra obj) { int o = __offset(32); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
