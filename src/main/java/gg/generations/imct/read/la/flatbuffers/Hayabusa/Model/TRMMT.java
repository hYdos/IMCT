...
public final class TRMMT extends Table {
  ...
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.MaterialTable material(int j) { return material(new gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.MaterialTable(), j); }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.MaterialTable material(gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.MaterialTable obj, int j) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int materialLength() { int o = __offset(8); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.MaterialTable.Vector materialVector() { return materialVector(new gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.MaterialTable.Vector()); }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.MaterialTable.Vector materialVector(gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.MaterialTable.Vector obj) { int o = __offset(8); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
