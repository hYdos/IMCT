...
public final class MaterialProperties extends Table {
  ...
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.MaterialMapper mappers(int j) { return mappers(new gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.MaterialMapper(), j); }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.MaterialMapper mappers(gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.MaterialMapper obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int mappersLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.MaterialMapper.Vector mappersVector() { return mappersVector(new gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.MaterialMapper.Vector()); }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.MaterialMapper.Vector mappersVector(gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.MaterialMapper.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.EmbeddedTRACM tracm() { return tracm(new gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.EmbeddedTRACM()); }
  public gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.EmbeddedTRACM tracm(gg.generations.imct.read.la.flatbuffers.Hayabusa.Model.EmbeddedTRACM obj) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
