...
public final class Transform extends Table {
  ...
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Vec3 vecScale() { return vecScale(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Vec3()); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Vec3 vecScale(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Vec3 obj) { int o = __offset(4); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Vec3 vecRot() { return vecRot(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Vec3()); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Vec3 vecRot(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Vec3 obj) { int o = __offset(6); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Vec3 vecTranslate() { return vecTranslate(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Vec3()); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Vec3 vecTranslate(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Vec3 obj) { int o = __offset(8); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
