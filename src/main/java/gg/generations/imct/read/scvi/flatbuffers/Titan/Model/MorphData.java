...
public final class MorphData extends Table {
  ...
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MorphAccessor attrs(int j) { return attrs(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MorphAccessor(), j); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MorphAccessor attrs(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MorphAccessor obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int attrsLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MorphAccessor.Vector attrsVector() { return attrsVector(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MorphAccessor.Vector()); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MorphAccessor.Vector attrsVector(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MorphAccessor.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MorphSize size(int j) { return size(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MorphSize(), j); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MorphSize size(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MorphSize obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int sizeLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MorphSize.Vector sizeVector() { return sizeVector(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MorphSize.Vector()); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MorphSize.Vector sizeVector(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MorphSize.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
