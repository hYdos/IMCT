...
public final class Bounds extends Table {
  ...
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Vec3 min() { return min(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Vec3()); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Vec3 min(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Vec3 obj) { int o = __offset(4); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Vec3 max() { return max(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Vec3()); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Vec3 max(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Vec3 obj) { int o = __offset(6); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
