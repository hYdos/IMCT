...
public final class SamplerState extends Table {
  ...
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.RGBA borderColor() { return borderColor(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.RGBA()); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.RGBA borderColor(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.RGBA obj) { int o = __offset(28); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
