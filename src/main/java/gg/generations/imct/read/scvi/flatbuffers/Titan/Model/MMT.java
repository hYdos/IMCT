...
public final class MMT extends Table {
  ...
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MaterialSwitches materialSwitches(int j) { return materialSwitches(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MaterialSwitches(), j); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MaterialSwitches materialSwitches(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MaterialSwitches obj, int j) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int materialSwitchesLength() { int o = __offset(8); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MaterialSwitches.Vector materialSwitchesVector() { return materialSwitchesVector(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MaterialSwitches.Vector()); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MaterialSwitches.Vector materialSwitchesVector(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MaterialSwitches.Vector obj) { int o = __offset(8); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MaterialProperties materialProperties(int j) { return materialProperties(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MaterialProperties(), j); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MaterialProperties materialProperties(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MaterialProperties obj, int j) { int o = __offset(10); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int materialPropertiesLength() { int o = __offset(10); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MaterialProperties.Vector materialPropertiesVector() { return materialPropertiesVector(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MaterialProperties.Vector()); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MaterialProperties.Vector materialPropertiesVector(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MaterialProperties.Vector obj) { int o = __offset(10); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
