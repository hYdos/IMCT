...
public final class Shader extends Table {
  ...
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.StringParameter shaderValues(int j) { return shaderValues(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.StringParameter(), j); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.StringParameter shaderValues(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.StringParameter obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int shaderValuesLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.StringParameter.Vector shaderValuesVector() { return shaderValuesVector(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.StringParameter.Vector()); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.StringParameter.Vector shaderValuesVector(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.StringParameter.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
