...
public final class TRMDL extends Table {
  ...
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.trmeshes meshes(int j) { return meshes(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.trmeshes(), j); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.trmeshes meshes(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.trmeshes obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int meshesLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.trmeshes.Vector meshesVector() { return meshesVector(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.trmeshes.Vector()); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.trmeshes.Vector meshesVector(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.trmeshes.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.trskeleton skeleton() { return skeleton(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.trskeleton()); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.trskeleton skeleton(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.trskeleton obj) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  ...
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Lod lods(int j) { return lods(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Lod(), j); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Lod lods(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Lod obj, int j) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int lodsLength() { int o = __offset(12); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Lod.Vector lodsVector() { return lodsVector(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Lod.Vector()); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Lod.Vector lodsVector(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Lod.Vector obj) { int o = __offset(12); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Bounds bounds() { return bounds(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Bounds()); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Bounds bounds(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Bounds obj) { int o = __offset(14); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Vec4 unkVec() { return unkVec(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Vec4()); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Vec4 unkVec(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Vec4 obj) { int o = __offset(16); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
