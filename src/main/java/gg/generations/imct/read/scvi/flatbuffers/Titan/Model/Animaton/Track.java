...
public final class Track extends Table {
  ...
  public String trackPath() { int o = __offset(4); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer trackPathAsByteBuffer() { return __vector_as_bytebuffer(4, 1); }
  public ByteBuffer trackPathInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 4, 1); }
  ...
  public TrackMaterialTimeline materialAnimation() { return materialAnimation(new TrackMaterialTimeline()); }
  public TrackMaterialTimeline materialAnimation(TrackMaterialTimeline obj) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public TrackFlags materialFlags() { return materialFlags(new TrackFlags()); }
  public TrackFlags materialFlags(TrackFlags obj) { int o = __offset(14); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  ...
  public static void startTrack(FlatBufferBuilder builder) { builder.startTable(6); }
  public static void addTrackPath(FlatBufferBuilder builder, int trackPathOffset) { builder.addOffset(0, trackPathOffset, 0); }
  ...
  public static void addMaterialAnimation(FlatBufferBuilder builder, int materialAnimationOffset) { builder.addOffset(4, materialAnimationOffset, 0); }
  public static void addMaterialFlags(FlatBufferBuilder builder, int materialFlagsOffset) { builder.addOffset(5, materialFlagsOffset, 0); }
