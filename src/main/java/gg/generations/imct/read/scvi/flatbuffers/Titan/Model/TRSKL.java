...
public final class TRSKL extends Table {
  ...
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.TransformNode transformNodes(int j) { return transformNodes(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.TransformNode(), j); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.TransformNode transformNodes(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.TransformNode obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int transformNodesLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.TransformNode.Vector transformNodesVector() { return transformNodesVector(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.TransformNode.Vector()); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.TransformNode.Vector transformNodesVector(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.TransformNode.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Bone bones(int j) { return bones(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Bone(), j); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Bone bones(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Bone obj, int j) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int bonesLength() { int o = __offset(8); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Bone.Vector bonesVector() { return bonesVector(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Bone.Vector()); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Bone.Vector bonesVector(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Bone.Vector obj) { int o = __offset(8); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.IKControl iks(int j) { return iks(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.IKControl(), j); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.IKControl iks(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.IKControl obj, int j) { int o = __offset(10); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int iksLength() { int o = __offset(10); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.IKControl.Vector iksVector() { return iksVector(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.IKControl.Vector()); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.IKControl.Vector iksVector(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.IKControl.Vector obj) { int o = __offset(10); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
