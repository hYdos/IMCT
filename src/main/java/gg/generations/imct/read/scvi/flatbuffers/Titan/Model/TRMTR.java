...
public final class TRMTR extends Table {
  ...
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Material materials(int j) { return materials(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Material(), j); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Material materials(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Material obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int materialsLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Material.Vector materialsVector() { return materialsVector(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Material.Vector()); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Material.Vector materialsVector(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.Material.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
