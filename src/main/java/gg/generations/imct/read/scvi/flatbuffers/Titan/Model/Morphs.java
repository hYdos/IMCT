...
public final class Morphs extends Table {
  ...
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MorphBuffer morphBuffer(int j) { return morphBuffer(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MorphBuffer(), j); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MorphBuffer morphBuffer(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MorphBuffer obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int morphBufferLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MorphBuffer.Vector morphBufferVector() { return morphBufferVector(new gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MorphBuffer.Vector()); }
  public gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MorphBuffer.Vector morphBufferVector(gg.generations.imct.read.scvi.flatbuffers.Titan.Model.MorphBuffer.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
