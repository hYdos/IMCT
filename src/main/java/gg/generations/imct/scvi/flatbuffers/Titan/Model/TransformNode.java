...
public final class TransformNode extends Table {
  ...
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Transform transform() { return transform(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Transform()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Transform transform(gg.generations.imct.scvi.flatbuffers.Titan.Model.Transform obj) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Vec3 scalePivot() { return scalePivot(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Vec3()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Vec3 scalePivot(gg.generations.imct.scvi.flatbuffers.Titan.Model.Vec3 obj) { int o = __offset(8); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Vec3 rotatePivot() { return rotatePivot(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Vec3()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Vec3 rotatePivot(gg.generations.imct.scvi.flatbuffers.Titan.Model.Vec3 obj) { int o = __offset(10); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
