...
public final class Buffer extends Table {
  ...
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Indexes indexBuffer(int j) { return indexBuffer(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Indexes(), j); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Indexes indexBuffer(gg.generations.imct.scvi.flatbuffers.Titan.Model.Indexes obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int indexBufferLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Indexes.Vector indexBufferVector() { return indexBufferVector(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Indexes.Vector()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Indexes.Vector indexBufferVector(gg.generations.imct.scvi.flatbuffers.Titan.Model.Indexes.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Vertices vertexBuffer(int j) { return vertexBuffer(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Vertices(), j); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Vertices vertexBuffer(gg.generations.imct.scvi.flatbuffers.Titan.Model.Vertices obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int vertexBufferLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Vertices.Vector vertexBufferVector() { return vertexBufferVector(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Vertices.Vector()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Vertices.Vector vertexBufferVector(gg.generations.imct.scvi.flatbuffers.Titan.Model.Vertices.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Morphs morphs(int j) { return morphs(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Morphs(), j); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Morphs morphs(gg.generations.imct.scvi.flatbuffers.Titan.Model.Morphs obj, int j) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int morphsLength() { int o = __offset(8); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Morphs.Vector morphsVector() { return morphsVector(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Morphs.Vector()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Morphs.Vector morphsVector(gg.generations.imct.scvi.flatbuffers.Titan.Model.Morphs.Vector obj) { int o = __offset(8); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
