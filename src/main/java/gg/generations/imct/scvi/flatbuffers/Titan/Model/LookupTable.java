...
public final class LookupTable extends Table {
  ...
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Vec3i unk2() { return unk2(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Vec3i()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Vec3i unk2(gg.generations.imct.scvi.flatbuffers.Titan.Model.Vec3i obj) { int o = __offset(8); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  ...
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Table2 baseShape(int j) { return baseShape(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Table2(), j); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Table2 baseShape(gg.generations.imct.scvi.flatbuffers.Titan.Model.Table2 obj, int j) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int baseShapeLength() { int o = __offset(12); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Table2.Vector baseShapeVector() { return baseShapeVector(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Table2.Vector()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Table2.Vector baseShapeVector(gg.generations.imct.scvi.flatbuffers.Titan.Model.Table2.Vector obj) { int o = __offset(12); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Vec3f somePositions(int j) { return somePositions(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Vec3f(), j); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Vec3f somePositions(gg.generations.imct.scvi.flatbuffers.Titan.Model.Vec3f obj, int j) { int o = __offset(14); return o != 0 ? obj.__assign(__vector(o) + j * 12, bb) : null; }
  public int somePositionsLength() { int o = __offset(14); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Vec3f.Vector somePositionsVector() { return somePositionsVector(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Vec3f.Vector()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Vec3f.Vector somePositionsVector(gg.generations.imct.scvi.flatbuffers.Titan.Model.Vec3f.Vector obj) { int o = __offset(14); return o != 0 ? obj.__assign(__vector(o), 12, bb) : null; }
