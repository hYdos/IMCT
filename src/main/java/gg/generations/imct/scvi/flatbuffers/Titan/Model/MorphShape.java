...
public final class MorphShape extends Table {
  ...
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.MorphData data(int j) { return data(new gg.generations.imct.scvi.flatbuffers.Titan.Model.MorphData(), j); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.MorphData data(gg.generations.imct.scvi.flatbuffers.Titan.Model.MorphData obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int dataLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.MorphData.Vector dataVector() { return dataVector(new gg.generations.imct.scvi.flatbuffers.Titan.Model.MorphData.Vector()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.MorphData.Vector dataVector(gg.generations.imct.scvi.flatbuffers.Titan.Model.MorphData.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.MorphMetaData metadata(int j) { return metadata(new gg.generations.imct.scvi.flatbuffers.Titan.Model.MorphMetaData(), j); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.MorphMetaData metadata(gg.generations.imct.scvi.flatbuffers.Titan.Model.MorphMetaData obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int metadataLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.MorphMetaData.Vector metadataVector() { return metadataVector(new gg.generations.imct.scvi.flatbuffers.Titan.Model.MorphMetaData.Vector()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.MorphMetaData.Vector metadataVector(gg.generations.imct.scvi.flatbuffers.Titan.Model.MorphMetaData.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
