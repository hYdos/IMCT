...
public final class Material extends Table {
  ...
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Shader shaders(int j) { return shaders(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Shader(), j); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Shader shaders(gg.generations.imct.scvi.flatbuffers.Titan.Model.Shader obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int shadersLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Shader.Vector shadersVector() { return shadersVector(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Shader.Vector()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Shader.Vector shadersVector(gg.generations.imct.scvi.flatbuffers.Titan.Model.Shader.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Texture textures(int j) { return textures(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Texture(), j); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Texture textures(gg.generations.imct.scvi.flatbuffers.Titan.Model.Texture obj, int j) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int texturesLength() { int o = __offset(8); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Texture.Vector texturesVector() { return texturesVector(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Texture.Vector()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Texture.Vector texturesVector(gg.generations.imct.scvi.flatbuffers.Titan.Model.Texture.Vector obj) { int o = __offset(8); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.SamplerState samplers(int j) { return samplers(new gg.generations.imct.scvi.flatbuffers.Titan.Model.SamplerState(), j); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.SamplerState samplers(gg.generations.imct.scvi.flatbuffers.Titan.Model.SamplerState obj, int j) { int o = __offset(10); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int samplersLength() { int o = __offset(10); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.SamplerState.Vector samplersVector() { return samplersVector(new gg.generations.imct.scvi.flatbuffers.Titan.Model.SamplerState.Vector()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.SamplerState.Vector samplersVector(gg.generations.imct.scvi.flatbuffers.Titan.Model.SamplerState.Vector obj) { int o = __offset(10); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.FloatParameter floatParameter(int j) { return floatParameter(new gg.generations.imct.scvi.flatbuffers.Titan.Model.FloatParameter(), j); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.FloatParameter floatParameter(gg.generations.imct.scvi.flatbuffers.Titan.Model.FloatParameter obj, int j) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int floatParameterLength() { int o = __offset(12); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.FloatParameter.Vector floatParameterVector() { return floatParameterVector(new gg.generations.imct.scvi.flatbuffers.Titan.Model.FloatParameter.Vector()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.FloatParameter.Vector floatParameterVector(gg.generations.imct.scvi.flatbuffers.Titan.Model.FloatParameter.Vector obj) { int o = __offset(12); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Float4Parameter float4LightParameter(int j) { return float4LightParameter(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Float4Parameter(), j); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Float4Parameter float4LightParameter(gg.generations.imct.scvi.flatbuffers.Titan.Model.Float4Parameter obj, int j) { int o = __offset(16); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int float4LightParameterLength() { int o = __offset(16); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Float4Parameter.Vector float4LightParameterVector() { return float4LightParameterVector(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Float4Parameter.Vector()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Float4Parameter.Vector float4LightParameterVector(gg.generations.imct.scvi.flatbuffers.Titan.Model.Float4Parameter.Vector obj) { int o = __offset(16); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Float4Parameter float4Parameter(int j) { return float4Parameter(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Float4Parameter(), j); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Float4Parameter float4Parameter(gg.generations.imct.scvi.flatbuffers.Titan.Model.Float4Parameter obj, int j) { int o = __offset(18); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int float4ParameterLength() { int o = __offset(18); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Float4Parameter.Vector float4ParameterVector() { return float4ParameterVector(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Float4Parameter.Vector()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Float4Parameter.Vector float4ParameterVector(gg.generations.imct.scvi.flatbuffers.Titan.Model.Float4Parameter.Vector obj) { int o = __offset(18); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.IntParameter intParameter(int j) { return intParameter(new gg.generations.imct.scvi.flatbuffers.Titan.Model.IntParameter(), j); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.IntParameter intParameter(gg.generations.imct.scvi.flatbuffers.Titan.Model.IntParameter obj, int j) { int o = __offset(22); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int intParameterLength() { int o = __offset(22); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.IntParameter.Vector intParameterVector() { return intParameterVector(new gg.generations.imct.scvi.flatbuffers.Titan.Model.IntParameter.Vector()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.IntParameter.Vector intParameterVector(gg.generations.imct.scvi.flatbuffers.Titan.Model.IntParameter.Vector obj) { int o = __offset(22); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Byte_Extra byteExtra() { return byteExtra(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Byte_Extra()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Byte_Extra byteExtra(gg.generations.imct.scvi.flatbuffers.Titan.Model.Byte_Extra obj) { int o = __offset(30); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Int_Extra intExtra() { return intExtra(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Int_Extra()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Int_Extra intExtra(gg.generations.imct.scvi.flatbuffers.Titan.Model.Int_Extra obj) { int o = __offset(32); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
