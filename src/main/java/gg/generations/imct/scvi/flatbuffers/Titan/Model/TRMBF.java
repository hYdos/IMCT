...
public final class TRMBF extends Table {
  ...
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Buffer buffers(int j) { return buffers(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Buffer(), j); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Buffer buffers(gg.generations.imct.scvi.flatbuffers.Titan.Model.Buffer obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int buffersLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Buffer.Vector buffersVector() { return buffersVector(new gg.generations.imct.scvi.flatbuffers.Titan.Model.Buffer.Vector()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.Buffer.Vector buffersVector(gg.generations.imct.scvi.flatbuffers.Titan.Model.Buffer.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
