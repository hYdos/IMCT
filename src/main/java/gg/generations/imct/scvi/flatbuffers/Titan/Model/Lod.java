...
public final class Lod extends Table {
  ...
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.LodIndex index(int j) { return index(new gg.generations.imct.scvi.flatbuffers.Titan.Model.LodIndex(), j); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.LodIndex index(gg.generations.imct.scvi.flatbuffers.Titan.Model.LodIndex obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int indexLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.LodIndex.Vector indexVector() { return indexVector(new gg.generations.imct.scvi.flatbuffers.Titan.Model.LodIndex.Vector()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.LodIndex.Vector indexVector(gg.generations.imct.scvi.flatbuffers.Titan.Model.LodIndex.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
