...
public final class MaterialProperties extends Table {
  ...
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.MaterialMapper mappers(int j) { return mappers(new gg.generations.imct.scvi.flatbuffers.Titan.Model.MaterialMapper(), j); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.MaterialMapper mappers(gg.generations.imct.scvi.flatbuffers.Titan.Model.MaterialMapper obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int mappersLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.MaterialMapper.Vector mappersVector() { return mappersVector(new gg.generations.imct.scvi.flatbuffers.Titan.Model.MaterialMapper.Vector()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.MaterialMapper.Vector mappersVector(gg.generations.imct.scvi.flatbuffers.Titan.Model.MaterialMapper.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.EmbeddedTRACM tracm() { return tracm(new gg.generations.imct.scvi.flatbuffers.Titan.Model.EmbeddedTRACM()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.EmbeddedTRACM tracm(gg.generations.imct.scvi.flatbuffers.Titan.Model.EmbeddedTRACM obj) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
