...
public final class Float4Parameter extends Table {
  ...
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.RGBA colorValue() { return colorValue(new gg.generations.imct.scvi.flatbuffers.Titan.Model.RGBA()); }
  public gg.generations.imct.scvi.flatbuffers.Titan.Model.RGBA colorValue(gg.generations.imct.scvi.flatbuffers.Titan.Model.RGBA obj) { int o = __offset(6); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
