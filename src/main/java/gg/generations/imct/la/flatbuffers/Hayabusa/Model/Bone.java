...
public final class Bone extends Table {
  ...
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.BoneMatrix matrix() { return matrix(new gg.generations.imct.la.flatbuffers.Hayabusa.Model.BoneMatrix()); }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.BoneMatrix matrix(gg.generations.imct.la.flatbuffers.Hayabusa.Model.BoneMatrix obj) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
