...
public final class Shader extends Table {
  ...
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.StringParameter shaderValues(int j) { return shaderValues(new gg.generations.imct.la.flatbuffers.Hayabusa.Model.StringParameter(), j); }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.StringParameter shaderValues(gg.generations.imct.la.flatbuffers.Hayabusa.Model.StringParameter obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int shaderValuesLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.StringParameter.Vector shaderValuesVector() { return shaderValuesVector(new gg.generations.imct.la.flatbuffers.Hayabusa.Model.StringParameter.Vector()); }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.StringParameter.Vector shaderValuesVector(gg.generations.imct.la.flatbuffers.Hayabusa.Model.StringParameter.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
