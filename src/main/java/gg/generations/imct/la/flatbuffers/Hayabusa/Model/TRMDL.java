...
public final class TRMDL extends Table {
  ...
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.FileReference meshes(int j) { return meshes(new gg.generations.imct.la.flatbuffers.Hayabusa.Model.FileReference(), j); }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.FileReference meshes(gg.generations.imct.la.flatbuffers.Hayabusa.Model.FileReference obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int meshesLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.FileReference.Vector meshesVector() { return meshesVector(new gg.generations.imct.la.flatbuffers.Hayabusa.Model.FileReference.Vector()); }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.FileReference.Vector meshesVector(gg.generations.imct.la.flatbuffers.Hayabusa.Model.FileReference.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.FileReference skeleton() { return skeleton(new gg.generations.imct.la.flatbuffers.Hayabusa.Model.FileReference()); }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.FileReference skeleton(gg.generations.imct.la.flatbuffers.Hayabusa.Model.FileReference obj) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  ...
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.LOD lods(int j) { return lods(new gg.generations.imct.la.flatbuffers.Hayabusa.Model.LOD(), j); }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.LOD lods(gg.generations.imct.la.flatbuffers.Hayabusa.Model.LOD obj, int j) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int lodsLength() { int o = __offset(12); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.LOD.Vector lodsVector() { return lodsVector(new gg.generations.imct.la.flatbuffers.Hayabusa.Model.LOD.Vector()); }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.LOD.Vector lodsVector(gg.generations.imct.la.flatbuffers.Hayabusa.Model.LOD.Vector obj) { int o = __offset(12); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.AABB bounds(gg.generations.imct.la.flatbuffers.Hayabusa.Model.AABB obj) { int o = __offset(14); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.Sphere spericalBounds() { return spericalBounds(new gg.generations.imct.la.flatbuffers.Hayabusa.Model.Sphere()); }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.Sphere spericalBounds(gg.generations.imct.la.flatbuffers.Hayabusa.Model.Sphere obj) { int o = __offset(16); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
