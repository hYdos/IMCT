...
public final class IKControl extends Table {
  ...
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.Vec3 ikPos() { return ikPos(new gg.generations.imct.la.flatbuffers.Hayabusa.Model.Vec3()); }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.Vec3 ikPos(gg.generations.imct.la.flatbuffers.Hayabusa.Model.Vec3 obj) { int o = __offset(14); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.Vec4 ikRot() { return ikRot(new gg.generations.imct.la.flatbuffers.Hayabusa.Model.Vec4()); }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.Vec4 ikRot(gg.generations.imct.la.flatbuffers.Hayabusa.Model.Vec4 obj) { int o = __offset(16); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
