...
public final class TRMSH extends Table {
  ...
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.MeshShape shapes(int j) { return shapes(new gg.generations.imct.la.flatbuffers.Hayabusa.Model.MeshShape(), j); }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.MeshShape shapes(gg.generations.imct.la.flatbuffers.Hayabusa.Model.MeshShape obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int shapesLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.MeshShape.Vector shapesVector() { return shapesVector(new gg.generations.imct.la.flatbuffers.Hayabusa.Model.MeshShape.Vector()); }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.MeshShape.Vector shapesVector(gg.generations.imct.la.flatbuffers.Hayabusa.Model.MeshShape.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
