...
public final class MeshShape extends Table {
  ...
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.AABB bounds() { return bounds(new gg.generations.imct.la.flatbuffers.Hayabusa.Model.AABB()); }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.AABB bounds(gg.generations.imct.la.flatbuffers.Hayabusa.Model.AABB obj) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public long indexLayoutFormat() { int o = __offset(8); return o != 0 ? (long)bb.getInt(o + bb_pos) & 0xFFFFFFFFL : 0L; }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.VertexAttributeLayout vertexLayout(int j) { return vertexLayout(new gg.generations.imct.la.flatbuffers.Hayabusa.Model.VertexAttributeLayout(), j); }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.VertexAttributeLayout vertexLayout(gg.generations.imct.la.flatbuffers.Hayabusa.Model.VertexAttributeLayout obj, int j) { int o = __offset(10); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int vertexLayoutLength() { int o = __offset(10); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.VertexAttributeLayout.Vector vertexLayoutVector() { return vertexLayoutVector(new gg.generations.imct.la.flatbuffers.Hayabusa.Model.VertexAttributeLayout.Vector()); }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.VertexAttributeLayout.Vector vertexLayoutVector(gg.generations.imct.la.flatbuffers.Hayabusa.Model.VertexAttributeLayout.Vector obj) { int o = __offset(10); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.SubMesh subMeshes(int j) { return subMeshes(new gg.generations.imct.la.flatbuffers.Hayabusa.Model.SubMesh(), j); }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.SubMesh subMeshes(gg.generations.imct.la.flatbuffers.Hayabusa.Model.SubMesh obj, int j) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int subMeshesLength() { int o = __offset(12); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.SubMesh.Vector subMeshesVector() { return subMeshesVector(new gg.generations.imct.la.flatbuffers.Hayabusa.Model.SubMesh.Vector()); }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.SubMesh.Vector subMeshesVector(gg.generations.imct.la.flatbuffers.Hayabusa.Model.SubMesh.Vector obj) { int o = __offset(12); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.Sphere sphericalBounds() { return sphericalBounds(new gg.generations.imct.la.flatbuffers.Hayabusa.Model.Sphere()); }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.Sphere sphericalBounds(gg.generations.imct.la.flatbuffers.Hayabusa.Model.Sphere obj) { int o = __offset(22); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.BoneWeight boneWeights(int j) { return boneWeights(new gg.generations.imct.la.flatbuffers.Hayabusa.Model.BoneWeight(), j); }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.BoneWeight boneWeights(gg.generations.imct.la.flatbuffers.Hayabusa.Model.BoneWeight obj, int j) { int o = __offset(24); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int boneWeightsLength() { int o = __offset(24); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.BoneWeight.Vector boneWeightsVector() { return boneWeightsVector(new gg.generations.imct.la.flatbuffers.Hayabusa.Model.BoneWeight.Vector()); }
  public gg.generations.imct.la.flatbuffers.Hayabusa.Model.BoneWeight.Vector boneWeightsVector(gg.generations.imct.la.flatbuffers.Hayabusa.Model.BoneWeight.Vector obj) { int o = __offset(24); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
