package gg.generations.imct.letsgo;

import de.javagl.jgltf.model.impl.DefaultNodeModel;
import gg.generations.imct.intermediate.Model;
import gg.generations.imct.swsh.flatbuffers.Gfbmdl.TextureMap;
import gg.generations.imct.swsh.flatbuffers.Gfbmdl.Vector3;
...
public class LGModel extends Model {
    ...
    public LGModel(Path modelDir) {
        var gfbmdl = gg.generations.imct.swsh.flatbuffers.Gfbmdl.Model.getRootAsModel(read(modelDir.resolve(modelDir.getFileName() + ".gfbmdl")));
