...
public final class Material extends Table {
  ...
  public gg.generations.imct.swsh.flatbuffers.Gfbmdl.TextureMap textureMaps(int j) { return textureMaps(new gg.generations.imct.swsh.flatbuffers.Gfbmdl.TextureMap(), j); }
  public gg.generations.imct.swsh.flatbuffers.Gfbmdl.TextureMap textureMaps(gg.generations.imct.swsh.flatbuffers.Gfbmdl.TextureMap obj, int j) { int o = __offset(26); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int textureMapsLength() { int o = __offset(26); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.swsh.flatbuffers.Gfbmdl.TextureMap.Vector textureMapsVector() { return textureMapsVector(new gg.generations.imct.swsh.flatbuffers.Gfbmdl.TextureMap.Vector()); }
  public gg.generations.imct.swsh.flatbuffers.Gfbmdl.TextureMap.Vector textureMapsVector(gg.generations.imct.swsh.flatbuffers.Gfbmdl.TextureMap.Vector obj) { int o = __offset(26); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public gg.generations.imct.swsh.flatbuffers.Gfbmdl.MatSwitch switches(gg.generations.imct.swsh.flatbuffers.Gfbmdl.MatSwitch obj, int j) { int o = __offset(28); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public gg.generations.imct.swsh.flatbuffers.Gfbmdl.MatSwitch.Vector switchesVector(gg.generations.imct.swsh.flatbuffers.Gfbmdl.MatSwitch.Vector obj) { int o = __offset(28); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public gg.generations.imct.swsh.flatbuffers.Gfbmdl.MatFloat values(int j) { return values(new gg.generations.imct.swsh.flatbuffers.Gfbmdl.MatFloat(), j); }
  public gg.generations.imct.swsh.flatbuffers.Gfbmdl.MatFloat values(gg.generations.imct.swsh.flatbuffers.Gfbmdl.MatFloat obj, int j) { int o = __offset(30); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int valuesLength() { int o = __offset(30); return o != 0 ? __vector_len(o) : 0; }
  public gg.generations.imct.swsh.flatbuffers.Gfbmdl.MatFloat.Vector valuesVector() { return valuesVector(new gg.generations.imct.swsh.flatbuffers.Gfbmdl.MatFloat.Vector()); }
  public gg.generations.imct.swsh.flatbuffers.Gfbmdl.MatFloat.Vector valuesVector(gg.generations.imct.swsh.flatbuffers.Gfbmdl.MatFloat.Vector obj) { int o = __offset(30); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public gg.generations.imct.swsh.flatbuffers.Gfbmdl.MatColor colors(gg.generations.imct.swsh.flatbuffers.Gfbmdl.MatColor obj, int j) { int o = __offset(32); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public gg.generations.imct.swsh.flatbuffers.Gfbmdl.MatColor.Vector colorsVector(gg.generations.imct.swsh.flatbuffers.Gfbmdl.MatColor.Vector obj) { int o = __offset(32); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public gg.generations.imct.swsh.flatbuffers.Gfbmdl.MaterialCommon common() { return common(new gg.generations.imct.swsh.flatbuffers.Gfbmdl.MaterialCommon()); }
  public gg.generations.imct.swsh.flatbuffers.Gfbmdl.MaterialCommon common(gg.generations.imct.swsh.flatbuffers.Gfbmdl.MaterialCommon obj) { int o = __offset(44); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
