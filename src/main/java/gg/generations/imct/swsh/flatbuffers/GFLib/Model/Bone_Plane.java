...
public final class Bone_Plane extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_23_3_3(); }
  public static Bone_Plane getRootAsBone_Plane(ByteBuffer _bb) { return getRootAsBone_Plane(_bb, new Bone_Plane()); }
  public static Bone_Plane getRootAsBone_Plane(ByteBuffer _bb, Bone_Plane obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public Bone_Plane __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }

  public String name() { int o = __offset(4); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer nameAsByteBuffer() { return __vector_as_bytebuffer(4, 1); }
  public ByteBuffer nameInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 4, 1); }
  public int parent() { int o = __offset(6); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  ...
  public gg.generations.imct.swsh.flatbuffers.GFLib.Model.Vec3 vecPos() { return vecPos(new gg.generations.imct.swsh.flatbuffers.GFLib.Model.Vec3()); }
  public gg.generations.imct.swsh.flatbuffers.GFLib.Model.Vec3 vecPos(gg.generations.imct.swsh.flatbuffers.GFLib.Model.Vec3 obj) { int o = __offset(14); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  ...
  public gg.generations.imct.swsh.flatbuffers.GFLib.Model.Vec3 vecScale(gg.generations.imct.swsh.flatbuffers.GFLib.Model.Vec3 obj) { int o = __offset(18); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  ...
  public static void startBone_Plane(FlatBufferBuilder builder) { builder.startTable(11); }
  ...
  public static void addVecPos(FlatBufferBuilder builder, int vecPosOffset) { builder.addStruct(5, vecPosOffset, 0); }
  public static void addVecRot(FlatBufferBuilder builder, int vecRotOffset) { builder.addStruct(6, vecRotOffset, 0); }
  public static void addVecScale(FlatBufferBuilder builder, int vecScaleOffset) { builder.addStruct(7, vecScaleOffset, 0); }
  ...
  public static int endBone_Plane(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public Bone_Plane get(int j) { return get(new Bone_Plane(), j); }
    public Bone_Plane get(Bone_Plane obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
