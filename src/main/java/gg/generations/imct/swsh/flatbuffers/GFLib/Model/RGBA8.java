...
public final class RGBA8 extends Struct {
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public RGBA8 __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createRGBA8(FlatBufferBuilder builder, int r, int g, int b, int a) {
    builder.prep(1, 4);
  ...
  public static final class Vector extends BaseVector {
    ...
    public RGBA8 get(int j) { return get(new RGBA8(), j); }
    public RGBA8 get(RGBA8 obj, int j) {  return obj.__assign(__element(j), bb); }
  }
}
